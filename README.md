...
FizzBuzz, but every decision is outsourced to a decision model.
...
Read the [full interview](https://anowell.com/posts/fizzbuzz-jev.html).

In 2016, Joel Grus shared [FizzBuzz with TensorFlow](https://joelgrus.com/2016/05/23/fizz-buzz-in-tensorflow/). A decade later we have [Jev](https://docs.typesafe.ai) whose docs clearly state: [*"Jev is not a calculator... implement any mathematical logic in code."*](https://anowell.com/posts/fizzbuzz-jev.html)
...
![FizzBuzz eval results: modulo 98.5%, divisible 95.0%, print 94.5%, classic 92.5%, vibes-rules 91.8%, fizziness 88.9%, vibes-game 62.2%, vibes 53.5%, always-number 53.3%, random-weighted 37.8%, random 23.5%. Words costs 10 to 27 points; binary collapses everything to the always-number baseline.](docs/results.png)
